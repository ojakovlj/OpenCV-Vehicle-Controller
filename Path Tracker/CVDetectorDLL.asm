; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.30319.01 
	...
	TITLE	C:\Users\Oleg\Documents\Visual Studio 2010\Projects\CVDetectorDLL\CVDetectorDLL.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; Function compile flags: /Ogtp
; File d:\opencv\opencv\build\include\opencv2\core\operations.hpp
_TEXT	ENDS
...
_TEXT	ENDS
PUBLIC	?getHorizontalAxis@RoadTracker@CVDetector@@SAHXZ ; CVDetector::RoadTracker::getHorizontalAxis
; Function compile flags: /Ogtp
; File c:\users\oleg\documents\visual studio 2010\projects\cvdetectordll\cvdetectordll.cpp
;	COMDAT ?getHorizontalAxis@RoadTracker@CVDetector@@SAHXZ
_TEXT	SEGMENT
?getHorizontalAxis@RoadTracker@CVDetector@@SAHXZ PROC	; CVDetector::RoadTracker::getHorizontalAxis, COMDAT

; 230  : 			return axisValue;

	mov	eax, DWORD PTR _axisValue

; 231  : 		}

	ret	0
?getHorizontalAxis@RoadTracker@CVDetector@@SAHXZ ENDP	; CVDetector::RoadTracker::getHorizontalAxis
_TEXT	ENDS
...
; Function compile flags: /Ogtp
; File d:\opencv\opencv\build\include\opencv2\core\mat.hpp
_TEXT	ENDS
...
; 414  : 		_Ptr_cat(_First, _Dest)));
	...
	mov	eax, DWORD PTR __Cat$145113[ebp]
...
; 414  : 		_Ptr_cat(_First, _Dest)));
	...
	mov	eax, DWORD PTR __Cat$145120[ebp]
	mov	ecx, DWORD PTR __Last$[ebp]
	mov	edx, DWORD PTR __First$[ebp]
	push	eax
	mov	eax, DWORD PTR __Dest$[ebp]
...
; 414  : 		_Ptr_cat(_First, _Dest)));
	...
	mov	eax, DWORD PTR __Cat$145127[ebp]
	mov	ecx, DWORD PTR __Last$[ebp]
	mov	edx, DWORD PTR __First$[ebp]
	push	eax
	mov	eax, DWORD PTR __Dest$[ebp]
...
; 414  : 		_Ptr_cat(_First, _Dest)));
	...
	mov	eax, DWORD PTR __Cat$145134[ebp]
	mov	ecx, DWORD PTR __Last$[ebp]
	mov	edx, DWORD PTR __First$[ebp]
	push	eax
	mov	eax, DWORD PTR __Dest$[ebp]
...
; 414  : 		_Ptr_cat(_First, _Dest)));
	...
	mov	eax, DWORD PTR __Cat$145141[ebp]
	mov	ecx, DWORD PTR __Last$[ebp]
	mov	edx, DWORD PTR __First$[ebp]
	push	eax
	mov	eax, DWORD PTR __Dest$[ebp]
...
; 37   : 		_THROW_NCEE(bad_alloc, 0);
	...
	lea	ecx, DWORD PTR $T145167[ebp]
	push	ecx
	lea	ecx, DWORD PTR $T145159[ebp]
	mov	DWORD PTR $T145167[ebp], 0
	call	DWORD PTR __imp_??0exception@std@@QAE@ABQBD@Z
	push	OFFSET __TI2?AVbad_alloc@std@@
	lea	edx, DWORD PTR $T145159[ebp]
	push	edx
	mov	DWORD PTR $T145159[ebp], OFFSET ??_7bad_alloc@std@@6B@
...
; 37   : 		_THROW_NCEE(bad_alloc, 0);
	...
	lea	eax, DWORD PTR $T145180[ebp]
	push	eax
	lea	ecx, DWORD PTR $T145172[ebp]
	mov	DWORD PTR $T145180[ebp], 0
	call	DWORD PTR __imp_??0exception@std@@QAE@ABQBD@Z
	push	OFFSET __TI2?AVbad_alloc@std@@
	lea	ecx, DWORD PTR $T145172[ebp]
	push	ecx
	mov	DWORD PTR $T145172[ebp], OFFSET ??_7bad_alloc@std@@6B@
	call	__CxxThrowException@8
$LN14@Allocate@2:
$LN7@Allocate@2:
...
; 37   : 		_THROW_NCEE(bad_alloc, 0);
	...
	push	ecx
	lea	ecx, DWORD PTR $T145185[ebp]
	mov	DWORD PTR $T145193[ebp], 0
	call	DWORD PTR __imp_??0exception@std@@QAE@ABQBD@Z
	push	OFFSET __TI2?AVbad_alloc@std@@
	lea	edx, DWORD PTR $T145185[ebp]
	push	edx
	mov	DWORD PTR $T145185[ebp], OFFSET ??_7bad_alloc@std@@6B@
	call	__CxxThrowException@8
$LN14@Allocate@3:
$LN7@Allocate@3:
...
; 37   : 		_THROW_NCEE(bad_alloc, 0);
	...
	lea	ecx, DWORD PTR $T145206[ebp]
	push	ecx
	lea	ecx, DWORD PTR $T145198[ebp]
	mov	DWORD PTR $T145206[ebp], 0
	call	DWORD PTR __imp_??0exception@std@@QAE@ABQBD@Z
	push	OFFSET __TI2?AVbad_alloc@std@@
	lea	edx, DWORD PTR $T145198[ebp]
	push	edx
	mov	DWORD PTR $T145198[ebp], OFFSET ??_7bad_alloc@std@@6B@
	call	__CxxThrowException@8
$LN14@Allocate@4:
$LN7@Allocate@4:
...
; 37   : 		_THROW_NCEE(bad_alloc, 0);
	...
	lea	ecx, DWORD PTR $T145219[ebp]
	push	ecx
	lea	ecx, DWORD PTR $T145211[ebp]
	mov	DWORD PTR $T145219[ebp], 0
	call	DWORD PTR __imp_??0exception@std@@QAE@ABQBD@Z
	push	OFFSET __TI2?AVbad_alloc@std@@
	lea	edx, DWORD PTR $T145211[ebp]
	push	edx
	mov	DWORD PTR $T145211[ebp], OFFSET ??_7bad_alloc@std@@6B@
	call	__CxxThrowException@8
$LN14@Allocate@5:
$LN7@Allocate@5:
...
; 37   : 		_THROW_NCEE(bad_alloc, 0);
	...
	lea	eax, DWORD PTR $T145232[ebp]
	push	eax
	lea	ecx, DWORD PTR $T145224[ebp]
	mov	DWORD PTR $T145232[ebp], 0
	call	DWORD PTR __imp_??0exception@std@@QAE@ABQBD@Z
	push	OFFSET __TI2?AVbad_alloc@std@@
	lea	ecx, DWORD PTR $T145224[ebp]
	push	ecx
	mov	DWORD PTR $T145224[ebp], OFFSET ??_7bad_alloc@std@@6B@
	call	__CxxThrowException@8
$LN14@Allocate@6:
$LN7@Allocate@6:
...
; 1318 : 			_Ptr, this->_Alval));
	...
	mov	eax, DWORD PTR __Cat$145247[ebp]
	mov	ecx, DWORD PTR __Last$[ebp]
	mov	edx, DWORD PTR __First$[ebp]
	push	eax
...
; 1318 : 			_Ptr, this->_Alval));
	...
	mov	eax, DWORD PTR __Cat$145263[ebp]
	mov	ecx, DWORD PTR __Last$[ebp]
	mov	edx, DWORD PTR __First$[ebp]
	push	eax
	mov	eax, DWORD PTR __Ptr$[ebp]
...
; 1318 : 			_Ptr, this->_Alval));
	...
	mov	eax, DWORD PTR __Cat$145279[ebp]
	mov	ecx, DWORD PTR __Last$[ebp]
	mov	edx, DWORD PTR __First$[ebp]
	push	eax
	mov	eax, DWORD PTR __Ptr$[ebp]
...
; 1318 : 			_Ptr, this->_Alval));
	...
	mov	eax, DWORD PTR __Cat$145295[ebp]
	mov	ecx, DWORD PTR __Last$[ebp]
	mov	edx, DWORD PTR __First$[ebp]
	push	eax
	mov	eax, DWORD PTR __Ptr$[ebp]
...
; 1318 : 			_Ptr, this->_Alval));
	...
	mov	eax, DWORD PTR __Cat$145311[ebp]
	mov	ecx, DWORD PTR __Last$[ebp]
	mov	edx, DWORD PTR __First$[ebp]
	push	eax
	mov	eax, DWORD PTR __Ptr$[ebp]
...
$LN3@allocate:
	...
	push	ecx
	lea	ecx, DWORD PTR $T145476[ebp]
	mov	DWORD PTR $T145474[ebp], 0
	call	DWORD PTR __imp_??0exception@std@@QAE@ABQBD@Z
	push	OFFSET __TI2?AVbad_alloc@std@@
	lea	edx, DWORD PTR $T145476[ebp]
	push	edx
	mov	DWORD PTR $T145476[ebp], OFFSET ??_7bad_alloc@std@@6B@
	call	__CxxThrowException@8
$LN13@allocate:
$LN1@allocate:
...
$LN3@allocate@2:
	...
	lea	ecx, DWORD PTR $T145505[ebp]
	push	ecx
	mov	DWORD PTR $T145505[ebp], OFFSET ??_7bad_alloc@std@@6B@
	call	__CxxThrowException@8
$LN13@allocate@2:
$LN1@allocate@2:
...
$LN3@allocate@4:
	lea	ecx, DWORD PTR $T145543[ebp]
	push	ecx
	lea	ecx, DWORD PTR $T145545[ebp]
	mov	DWORD PTR $T145543[ebp], 0
	call	DWORD PTR __imp_??0exception@std@@QAE@ABQBD@Z
	push	OFFSET __TI2?AVbad_alloc@std@@
	lea	edx, DWORD PTR $T145545[ebp]
	push	edx
	mov	DWORD PTR $T145545[ebp], OFFSET ??_7bad_alloc@std@@6B@
	call	__CxxThrowException@8
$LN13@allocate@4:
$LN1@allocate@4:
...
$LN3@allocate@5:
	lea	ecx, DWORD PTR $T145566[ebp]
	push	ecx
	lea	ecx, DWORD PTR $T145568[ebp]
	mov	DWORD PTR $T145566[ebp], 0
	call	DWORD PTR __imp_??0exception@std@@QAE@ABQBD@Z
	push	OFFSET __TI2?AVbad_alloc@std@@
	lea	edx, DWORD PTR $T145568[ebp]
	push	edx
	mov	DWORD PTR $T145568[ebp], OFFSET ??_7bad_alloc@std@@6B@
	call	__CxxThrowException@8
$LN13@allocate@5:
$LN1@allocate@5:
...
$LN3@allocate@6:
	lea	eax, DWORD PTR $T145928[ebp]
	push	eax
	lea	ecx, DWORD PTR $T145930[ebp]
	mov	DWORD PTR $T145928[ebp], 0
	call	DWORD PTR __imp_??0exception@std@@QAE@ABQBD@Z
	push	OFFSET __TI2?AVbad_alloc@std@@
	lea	ecx, DWORD PTR $T145930[ebp]
	push	ecx
	mov	DWORD PTR $T145930[ebp], OFFSET ??_7bad_alloc@std@@6B@
	call	__CxxThrowException@8
$LN13@allocate@6:
$LN1@allocate@6:
...
_TEXT	SEGMENT
__Oldptr$129460 = -8					; size = 4
__Newsize$129453 = -4					; size = 4
__Meta$ = 8						; size = 4
...
; 148  : 			_Newsize += _Inc;
	...
	mov	DWORD PTR __Newsize$129453[ebp], ecx
...
; 151  : 			_Elem *_Oldptr = _Mysb::eback();
	...
	mov	edx, DWORD PTR [edx]
	mov	edi, eax
	mov	DWORD PTR __Oldptr$129460[ebp], edx
...
; 154  : 				_Traits::copy(_Newptr, _Oldptr, _Oldsize);
	...
	push	edi
	call	_memcpy
	mov	edx, DWORD PTR __Oldptr$129460[ebp]
	add	esp, 12					; 0000000cH
...
; 159  : 				_Mysb::setp(_Newptr, _Newptr + _Newsize);
	...
	mov	eax, DWORD PTR [esi+52]
	mov	ecx, DWORD PTR __Newsize$129453[ebp]
	mov	DWORD PTR [eax], ecx
...
; 170  : 					_Newptr + _Newsize);
	...
	mov	ecx, edi
	sub	ecx, eax
	add	ecx, DWORD PTR __Newsize$129453[ebp]
	mov	eax, DWORD PTR [esi+52]
	mov	DWORD PTR [eax], ecx
...
;	COMDAT xdata$x
; File e:\program files (x86)\microsoft visual studio 10.0\vc\include\istream
xdata$x	SEGMENT
...
; 539  : 				this->_Myfirst);
	...
	mov	edx, DWORD PTR __Cat$146455[ebp]
...
; 539  : 				this->_Myfirst);
	...
	mov	edx, DWORD PTR __Cat$146590[ebp]
	shl	esi, 4
	add	esi, eax
	mov	DWORD PTR [edi], eax
	mov	DWORD PTR [edi+4], eax
...
; 539  : 				this->_Myfirst);
	...
	mov	edx, DWORD PTR __Cat$146724[ebp]
	lea	ecx, DWORD PTR [eax+edi*4]
	mov	DWORD PTR [esi], eax
	mov	DWORD PTR [esi+4], eax
	mov	DWORD PTR [esi+8], ecx
...
; 539  : 				this->_Myfirst);
	...
	mov	edx, DWORD PTR __Cat$146859[ebp]
	mov	DWORD PTR [esi], eax
	mov	DWORD PTR [esi+4], eax
	mov	ecx, DWORD PTR [ebx+4]
	mov	ebx, DWORD PTR [ebx]
...
; 539  : 				this->_Myfirst);
	...
	mov	edx, DWORD PTR __Cat$146994[ebp]
	lea	ecx, DWORD PTR [eax+edi*4]
	mov	DWORD PTR [esi], eax
	mov	DWORD PTR [esi+4], eax
	mov	DWORD PTR [esi+8], ecx
...
; Function compile flags: /Ogtp
; File d:\opencv\opencv\build\include\opencv2\imgproc\imgproc.hpp
CONST	ENDS
...
$LN46@Copy:
	...
	push	ecx
	lea	ecx, DWORD PTR $T147402[ebp]
	mov	DWORD PTR $T147379[ebp], 0
	call	DWORD PTR __imp_??0exception@std@@QAE@ABQBD@Z
	push	OFFSET __TI2?AVbad_alloc@std@@
	lea	edx, DWORD PTR $T147402[ebp]
	push	edx
	mov	DWORD PTR $T147402[ebp], OFFSET ??_7bad_alloc@std@@6B@
	call	__CxxThrowException@8
$LN112@Copy:
...
PUBLIC	__$ArrayPad$
PUBLIC	?trackFilteredObject@CVDetector@@YAHVMat@cv@@@Z	; CVDetector::trackFilteredObject
...
;	COMDAT xdata$x
xdata$x	SEGMENT
__unwindtable$?trackFilteredObject@CVDetector@@YAHVMat@cv@@@Z DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?trackFilteredObject@CVDetector@@YAHVMat@cv@@@Z$0
	DD	00H
	DD	FLAT:__unwindfunclet$?trackFilteredObject@CVDetector@@YAHVMat@cv@@@Z$1
	DD	01H
	DD	FLAT:__unwindfunclet$?trackFilteredObject@CVDetector@@YAHVMat@cv@@@Z$2
	DD	02H
	DD	FLAT:__unwindfunclet$?trackFilteredObject@CVDetector@@YAHVMat@cv@@@Z$3
	DD	03H
	DD	00H
	DD	03H
	DD	FLAT:__unwindfunclet$?trackFilteredObject@CVDetector@@YAHVMat@cv@@@Z$4
__ehfuncinfo$?trackFilteredObject@CVDetector@@YAHVMat@cv@@@Z DD 019930522H
	DD	06H
	DD	FLAT:__unwindtable$?trackFilteredObject@CVDetector@@YAHVMat@cv@@@Z
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
...
; File c:\users\oleg\documents\visual studio 2010\projects\cvdetectordll\cvdetectordll.cpp
xdata$x	ENDS
;	COMDAT ?trackFilteredObject@CVDetector@@YAHVMat@cv@@@Z
_TEXT	SEGMENT
_moment$127103 = -432					; size = 192
$T147907 = -240						; size = 20
$T147906 = -240						; size = 20
$T147904 = -220						; size = 20
_refArea$ = -200					; size = 8
$T147905 = -192						; size = 20
$T147902 = -192						; size = 20
_hierarchy$ = -172					; size = 16
_contours$ = -156					; size = 16
_x$ = -140						; size = 4
$T147903 = -140						; size = 4
_axis$ = -136						; size = 4
_objectFound$ = -129					; size = 1
$T127113 = -128						; size = 56
_temp$ = -72						; size = 56
__$ArrayPad$ = -16					; size = 4
__$EHRec$ = -12						; size = 12
_thresholded$ = 8					; size = 56
?trackFilteredObject@CVDetector@@YAHVMat@cv@@@Z PROC	; CVDetector::trackFilteredObject, COMDAT

; 111  : 	int trackFilteredObject(Mat thresholded){

	push	ebp
	mov	ebp, esp
	push	-1
	push	__ehhandler$?trackFilteredObject@CVDetector@@YAHVMat@cv@@@Z
	mov	eax, DWORD PTR fs:0
	push	eax
...
; 113  : 		Mat temp;
	...
	mov	DWORD PTR _axis$[ebp], -2		; fffffffeH
...
; 118  : 		//find contours of filtered image using openCV findContours function
; 119  : 		findContours(temp,contours,hierarchy,CV_RETR_CCOMP,CV_CHAIN_APPROX_SIMPLE );

	mov	eax, OFFSET ??_7_OutputArray@cv@@6B@
	lea	ecx, DWORD PTR _hierarchy$[ebp]
	mov	DWORD PTR $T147904[ebp], eax
	mov	DWORD PTR $T147905[ebp], eax
	lea	eax, DWORD PTR _temp$[ebp]
	mov	DWORD PTR $T147904[ebp+8], ecx
	lea	edx, DWORD PTR _contours$[ebp]
	push	eax
	lea	ecx, DWORD PTR $T147906[ebp]
	mov	DWORD PTR $T147904[ebp+4], -2147287012	; 8003001cH
	mov	DWORD PTR $T147904[ebp+12], ebx
	mov	DWORD PTR $T147904[ebp+16], ebx
	mov	DWORD PTR $T147905[ebp+4], -2147221492	; 8004000cH
	mov	DWORD PTR $T147905[ebp+8], edx
	mov	DWORD PTR $T147905[ebp+12], ebx
	mov	DWORD PTR $T147905[ebp+16], ebx
	call	esi
	sub	esp, 8
	mov	eax, esp
	mov	DWORD PTR $T147903[ebp], esp
	push	2
	push	2
	...
	mov	DWORD PTR [eax+4], ebx
	push	edx
	lea	eax, DWORD PTR $T147906[ebp]
	push	eax
	call	DWORD PTR __imp_?findContours@cv@@YAXABV_OutputArray@1@00HHV?$Point_@H@1@@Z

; 120  : 		//use moments method to find our filtered object
; 121  : 		double refArea = 0;

	fldz

; 122  : 		bool objectFound = false;
; 123  : 		if (hierarchy.size() > 0) {
...
; 124  : 			int numObjects = hierarchy.size();
; 125  : 			//if number of objects greater than MAX_NUM_OBJECTS we have a noisy filter
; 126  : 			if(numObjects<MAX_NUM_OBJECTS){

	cmp	eax, 50					; 00000032H
	jge	$LN2@trackFilte

; 127  : 				objectFound = false;
...
; 130  : 					Moments moment = moments((cv::Mat)contours[index]);
	...
	add	esi, esi
	mov	DWORD PTR $T127113[ebp], 1124024332	; 42ff400cH
	mov	DWORD PTR $T127113[ebp+4], 2
	mov	eax, DWORD PTR [ecx+esi*8+4]
	sub	eax, DWORD PTR [ecx+esi*8]
	lea	edx, DWORD PTR $T127113[ebp+8]
	mov	DWORD PTR $T127113[ebp+40], edx
	sar	eax, 3
	lea	edx, DWORD PTR $T127113[ebp+48]
	mov	DWORD PTR $T127113[ebp+8], eax
	mov	DWORD PTR $T127113[ebp+12], 1
	mov	DWORD PTR $T127113[ebp+16], ebx
	mov	DWORD PTR $T127113[ebp+20], ebx
	mov	DWORD PTR $T127113[ebp+24], ebx
	mov	DWORD PTR $T127113[ebp+28], ebx
	mov	DWORD PTR $T127113[ebp+36], ebx
	mov	DWORD PTR $T127113[ebp+44], edx
	mov	DWORD PTR $T127113[ebp+52], ebx
	mov	DWORD PTR $T127113[ebp+48], ebx
	mov	edx, DWORD PTR [ecx+esi*8]
	cmp	edx, DWORD PTR [ecx+esi*8+4]
	je	SHORT $LN67@trackFilte
	mov	edx, 8
	mov	DWORD PTR $T127113[ebp+52], edx
	mov	DWORD PTR $T127113[ebp+48], edx
	mov	ecx, DWORD PTR [ecx+esi*8]
	lea	eax, DWORD PTR [ecx+eax*8]
	mov	DWORD PTR $T127113[ebp+24], ecx
	mov	DWORD PTR $T127113[ebp+16], ecx
	mov	DWORD PTR $T127113[ebp+28], eax
	mov	DWORD PTR $T127113[ebp+32], eax
$LN67@trackFilte:
	lea	eax, DWORD PTR $T127113[ebp]
	push	eax
	...
	lea	ecx, DWORD PTR $T147907[ebp]
	push	ecx
	lea	edx, DWORD PTR _moment$127103[ebp]
	push	edx
...
; 135  : 					//we only want the object with the largest area so we safe a reference area each
...
; 137  : 					if(area>MIN_OBJECT_AREA && area<MAX_OBJECT_AREA && area>refArea){
	...
	fld	QWORD PTR _moment$127103[ebp]
	fcom	ST(1)
	fnstsw	ax
	fstp	ST(1)
	test	ah, 65					; 00000041H
	jne	SHORT $LN187@trackFilte
	...
	fnstsw	ax
	test	ah, 5
	jp	SHORT $LN187@trackFilte

; 138  : 						x = moment.m10/area;

	fld	QWORD PTR _moment$127103[ebp+8]
	fdiv	ST(0), ST(1)
	call	__ftol2_sse
...
; 142  : 					}
; 143  : 				}
; 144  : 				if(objectFound == true){

	cmp	BYTE PTR _objectFound$[ebp], 1
	jne	SHORT $LN2@trackFilte

; 145  : 					if( x > width/2 + 200)
	...
	sub	eax, edx
	sar	eax, 1
	lea	edx, DWORD PTR [eax+200]
	cmp	esi, edx
	jle	SHORT $LN4@trackFilte

; 146  : 						axis = 1; //RIGHT

	mov	DWORD PTR _axis$[ebp], 1
	jmp	SHORT $LN2@trackFilte
$LN4@trackFilte:

; 147  : 					else if( x < width/2 - 200)
...
$LN100@trackFilte:
	...
	mov	DWORD PTR _hierarchy$[ebp+8], ebx
	cmp	esi, ebx
	je	SHORT $LN142@trackFilte
	mov	eax, DWORD PTR _contours$[ebp+4]
	mov	edi, eax
	cmp	esi, eax
	je	SHORT $LN117@trackFilte
	npad	1
$LL119@trackFilte:
	mov	eax, DWORD PTR [esi]
	cmp	eax, ebx
	je	SHORT $LN138@trackFilte
	push	eax
	call	DWORD PTR __imp_??3@YAXPAX@Z
	add	esp, 4
$LN138@trackFilte:
...
$LN142@trackFilte:
	...
	mov	eax, DWORD PTR _temp$[ebp+20]
	mov	esi, DWORD PTR __imp_?_interlockedExchangeAdd@cv@@YAHPAHH@Z
	mov	DWORD PTR _contours$[ebp], ebx
	mov	DWORD PTR _contours$[ebp+4], ebx
	mov	DWORD PTR _contours$[ebp+8], ebx
	cmp	eax, ebx
	je	SHORT $LN152@trackFilte
	push	-1
	push	eax
	call	esi
	add	esp, 8
	cmp	eax, 1
	jne	SHORT $LN152@trackFilte
...
$LN152@trackFilte:
	...
	mov	DWORD PTR _temp$[ebp+24], ebx
	mov	DWORD PTR _temp$[ebp+16], ebx
	cmp	DWORD PTR _temp$[ebp+4], ebx
	jle	SHORT $LN149@trackFilte
	npad	6
$LL151@trackFilte:
	mov	ecx, DWORD PTR _temp$[ebp+40]
	mov	DWORD PTR [ecx+eax*4], ebx
	inc	eax
	cmp	eax, DWORD PTR _temp$[ebp+4]
	jl	SHORT $LL151@trackFilte
$LN149@trackFilte:
	mov	eax, DWORD PTR _temp$[ebp+44]
	mov	edi, DWORD PTR __imp_?fastFree@cv@@YAXPAX@Z
	lea	edx, DWORD PTR _temp$[ebp+48]
	mov	DWORD PTR _temp$[ebp+20], ebx
	cmp	eax, edx
	je	SHORT $LN146@trackFilte
	push	eax
	call	edi
	add	esp, 4
$LN146@trackFilte:
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	eax, DWORD PTR _thresholded$[ebp+20]
	cmp	eax, ebx
	je	SHORT $LN161@trackFilte
	push	-1
	push	eax
	call	esi
	add	esp, 8
	cmp	eax, 1
	jne	SHORT $LN161@trackFilte
	lea	ecx, DWORD PTR _thresholded$[ebp]
	call	DWORD PTR __imp_?deallocate@Mat@cv@@QAEXXZ
$LN161@trackFilte:
	xor	eax, eax
	mov	DWORD PTR _thresholded$[ebp+32], ebx
	mov	DWORD PTR _thresholded$[ebp+28], ebx
	mov	DWORD PTR _thresholded$[ebp+24], ebx
	mov	DWORD PTR _thresholded$[ebp+16], ebx
	cmp	DWORD PTR _thresholded$[ebp+4], ebx
	jle	SHORT $LN158@trackFilte
	npad	4
$LL160@trackFilte:
	mov	ecx, DWORD PTR _thresholded$[ebp+40]
	mov	DWORD PTR [ecx+eax*4], ebx
	inc	eax
	cmp	eax, DWORD PTR _thresholded$[ebp+4]
	jl	SHORT $LL160@trackFilte
$LN158@trackFilte:
	mov	eax, DWORD PTR _thresholded$[ebp+44]
	lea	edx, DWORD PTR _thresholded$[ebp+48]
	mov	DWORD PTR _thresholded$[ebp+20], ebx
	cmp	eax, edx
	je	SHORT $LN172@trackFilte
	push	eax
	call	edi
	add	esp, 4
$LN172@trackFilte:
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$?trackFilteredObject@CVDetector@@YAHVMat@cv@@@Z$0:
	lea	eax, DWORD PTR _thresholded$[ebp]
	jmp	??1Mat@cv@@QAE@XZ			; cv::Mat::~Mat
__unwindfunclet$?trackFilteredObject@CVDetector@@YAHVMat@cv@@@Z$1:
	lea	eax, DWORD PTR _temp$[ebp]
	jmp	??1Mat@cv@@QAE@XZ			; cv::Mat::~Mat
__unwindfunclet$?trackFilteredObject@CVDetector@@YAHVMat@cv@@@Z$2:
	lea	ebx, DWORD PTR _contours$[ebp]
	jmp	??1?$vector@V?$vector@V?$Point_@H@cv@@V?$allocator@V?$Point_@H@cv@@@std@@@std@@V?$allocator@V?$vector@V?$Point_@H@cv@@V?$allocator@V?$Point_@H@cv@@@std@@@std@@@2@@std@@QAE@XZ ; std::vector<std::vector<cv::Point_<int>,std::allocator<cv::Point_<int> > >,std::allocator<std::vector<cv::Point_<int>,std::allocator<cv::Point_<int> > > > >::~vector<std::vector<cv::Point_<int>,std::allocator<cv::Point_<int> > >,std::allocator<std::vector<cv::Point_<int>,std::allocator<cv::Point_<int> > > > >
__unwindfunclet$?trackFilteredObject@CVDetector@@YAHVMat@cv@@@Z$3:
	lea	esi, DWORD PTR _hierarchy$[ebp]
	jmp	??1?$vector@V?$Vec@H$03@cv@@V?$allocator@V?$Vec@H$03@cv@@@std@@@std@@QAE@XZ ; std::vector<cv::Vec<int,4>,std::allocator<cv::Vec<int,4> > >::~vector<cv::Vec<int,4>,std::allocator<cv::Vec<int,4> > >
__unwindfunclet$?trackFilteredObject@CVDetector@@YAHVMat@cv@@@Z$4:
	lea	eax, DWORD PTR $T127113[ebp]
	jmp	??1Mat@cv@@QAE@XZ			; cv::Mat::~Mat
__ehhandler$?trackFilteredObject@CVDetector@@YAHVMat@cv@@@Z:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	...
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$?trackFilteredObject@CVDetector@@YAHVMat@cv@@@Z
	jmp	___CxxFrameHandler3
text$x	ENDS
?trackFilteredObject@CVDetector@@YAHVMat@cv@@@Z ENDP	; CVDetector::trackFilteredObject
...
; 88   : 		cvtColor( frame, frame_gray, CV_BGR2GRAY );
	...
	mov	esi, DWORD PTR __imp_??0_OutputArray@cv@@QAE@AAVMat@1@@Z
	push	edx
	lea	ecx, DWORD PTR $T148505[ebp]
	call	esi
	mov	edi, DWORD PTR __imp_??0_InputArray@cv@@QAE@ABVMat@1@@Z
	lea	eax, DWORD PTR _frame$[ebp]
	push	eax
	lea	ecx, DWORD PTR $T148506[ebp]
	call	edi
	push	ebx
	push	6
	lea	ecx, DWORD PTR $T148505[ebp]
	push	ecx
	lea	edx, DWORD PTR $T148506[ebp]
	push	edx
...
; 89   : 		equalizeHist( frame_gray, frame_gray );
	...
	push	eax
	lea	ecx, DWORD PTR $T148507[ebp]
	call	esi
	lea	ecx, DWORD PTR _frame_gray$[ebp]
	push	ecx
	lea	ecx, DWORD PTR $T148508[ebp]
	call	edi
	lea	edx, DWORD PTR $T148507[ebp]
	push	edx
	lea	eax, DWORD PTR $T148508[ebp]
	push	eax
...
; 93   : 		disableCascade.detectMultiScale( frame_gray, disableSigns, 1.1, 2, 0|CV_HAAR_SCALE_IMAGE, Size(30, 30));
	...
	sub	esp, 8
	mov	eax, esp
	mov	DWORD PTR $T148511[ebp], esp
	sub	esp, 8
	mov	DWORD PTR [eax], ebx
	mov	DWORD PTR [eax+4], ebx
	mov	eax, esp
	mov	DWORD PTR $T148512[ebp], esp
	push	2
	push	2
	sub	esp, 8
	mov	DWORD PTR [eax], edi
...
; 97   : 			ellipse( frame, center, Size( enableSigns[i].width*0.5, enableSigns[i].height*0.5), 0, 0, 360, Scalar( 255, 0, 255 ), 4, 8, 0 );
	...
	fxch	ST(1)
	mov	DWORD PTR _center$126003[ebp], eax
	xor	eax, eax
	push	ebx
	mov	DWORD PTR $T126005[ebp], eax
	mov	DWORD PTR $T126005[ebp+4], eax
	fst	QWORD PTR $T126005[ebp]
	mov	DWORD PTR $T126005[ebp+16], eax
	mov	DWORD PTR $T126005[ebp+20], eax
	fstp	QWORD PTR $T126005[ebp+16]
	push	8
	mov	DWORD PTR $T126005[ebp+8], eax
	mov	DWORD PTR $T126005[ebp+12], eax
	fst	QWORD PTR $T126005[ebp+8]
	push	4
	lea	ecx, DWORD PTR $T126005[ebp]
	mov	DWORD PTR $T126005[ebp+24], eax
	mov	DWORD PTR $T126005[ebp+28], eax
	fst	QWORD PTR $T126005[ebp+24]
	...
	call	__ftol2_sse
	mov	edx, DWORD PTR $T148668[ebp]
	sub	esp, 8
	mov	ecx, esp
	mov	DWORD PTR [ecx], eax
	mov	DWORD PTR $T148513[ebp], esp
	mov	DWORD PTR [ecx+4], edx
	mov	ecx, DWORD PTR _center$126003[ebp]
	mov	edx, DWORD PTR $T148627[ebp]
	sub	esp, 8
	mov	eax, esp
	mov	DWORD PTR [eax], ecx
	mov	DWORD PTR [eax+4], edx
	lea	eax, DWORD PTR _frame$[ebp]
	mov	DWORD PTR $T148514[ebp], esp
	push	eax
...
$LN13@hwnd2mat:
	mov	DWORD PTR _sz$148966[ebp], eax
	push	24					; 00000018H
	lea	eax, DWORD PTR _sz$148966[ebp]
	push	eax
	mov	DWORD PTR _sz$148966[ebp+4], ecx
	push	2
	mov	ecx, esi
	call	DWORD PTR __imp_?create@Mat@cv@@QAEXHPBHH@Z
$LN14@hwnd2mat:
...
__unwindfunclet$?hwnd2mat@CVDetector@@YA?AVMat@cv@@PAUHWND__@@@Z$0:
	mov	eax, DWORD PTR $T148935[ebp]
	and	eax, 1
	je	$LN4@hwnd2mat
	and	DWORD PTR $T148935[ebp], -2		; fffffffeH
...
_dst$ = -280						; size = 56
$T127190 = -224						; size = 32
_erodeElement$ = -188					; size = 56
_dilateElement$ = -132					; size = 56
_frame$ = -76						; size = 56
...
; 198  : 		{			
	...
	xor	eax, esp
	push	eax
	lea	eax, DWORD PTR __$EHRec$[esp+412]
	mov	DWORD PTR fs:0, eax

; 199  : 			Mat frame = hwnd2mat(hDesktopWnd);

	lea	esi, DWORD PTR _frame$[esp+412]
	call	?hwnd2mat@CVDetector@@YA?AVMat@cv@@PAUHWND__@@@Z ; CVDetector::hwnd2mat
	xor	ebx, ebx
	mov	DWORD PTR __$EHRec$[esp+420], ebx

; 200  : 			Mat dst;

	lea	eax, DWORD PTR _dst$[esp+420]
	lea	ecx, DWORD PTR _dst$[esp+460]
	mov	DWORD PTR _dst$[esp+452], eax
	mov	DWORD PTR _dst$[esp+456], ecx
	mov	DWORD PTR _dst$[esp+464], ebx
	mov	DWORD PTR _dst$[esp+460], ebx
	mov	DWORD PTR _dst$[esp+412], 1124007936	; 42ff0000H
	mov	DWORD PTR _dst$[esp+424], ebx
	mov	DWORD PTR _dst$[esp+420], ebx
	mov	DWORD PTR _dst$[esp+416], ebx
	mov	DWORD PTR _dst$[esp+444], ebx
	mov	DWORD PTR _dst$[esp+440], ebx
	mov	DWORD PTR _dst$[esp+436], ebx
	mov	DWORD PTR _dst$[esp+428], ebx
	mov	DWORD PTR _dst$[esp+432], ebx
	mov	DWORD PTR _dst$[esp+448], ebx

; 201  : 			//Convert to HSV
; 202  : 			cvtColor(frame,dst,COLOR_BGR2HSV);

	lea	edx, DWORD PTR _dst$[esp+412]
	mov	BYTE PTR __$EHRec$[esp+420], 1
	mov	edi, DWORD PTR __imp_??0_OutputArray@cv@@QAE@AAVMat@1@@Z
	push	edx
	lea	ecx, DWORD PTR $T149230[esp+416]
	call	edi
	mov	eax, esi
	mov	esi, DWORD PTR __imp_??0_InputArray@cv@@QAE@ABVMat@1@@Z
	push	eax
	lea	ecx, DWORD PTR $T149231[esp+416]
	call	esi
	push	ebx
	push	40					; 00000028H
	lea	ecx, DWORD PTR $T149230[esp+420]
	push	ecx
	lea	edx, DWORD PTR $T149231[esp+424]
	push	edx
	call	DWORD PTR __imp_?cvtColor@cv@@YAXABV_InputArray@1@ABV_OutputArray@1@HH@Z
	add	esp, 16					; 00000010H

; 203  : 			// Apply threshold to eliminate noise and emphasize filtered objects
; 204  : 			// These HSV values work best for Red color
; 205  : 			inRange(dst,Scalar(0,156,0),Scalar(21,256,256),dst);

	lea	eax, DWORD PTR _dst$[esp+412]
	push	eax
	lea	ecx, DWORD PTR $T149232[esp+416]
	call	edi
	fld	QWORD PTR __real@4035000000000000
	fstp	QWORD PTR $T127190[esp+412]
	lea	ecx, DWORD PTR $T127190[esp+412]
	fld	QWORD PTR __real@4070000000000000
	mov	eax, 1
	fst	QWORD PTR $T127190[esp+420]
	mov	edx, -1073610746			; c0020006H
	fstp	QWORD PTR $T127190[esp+428]
	mov	DWORD PTR $T149233[esp+420], ecx
	fldz
	mov	ecx, 4
	fst	QWORD PTR $T127190[esp+436]
	mov	DWORD PTR $T149233[esp+424], eax
	fst	QWORD PTR $T127189[esp+412]
	mov	DWORD PTR $T149234[esp+424], eax
	fld	QWORD PTR __real@4063800000000000
	mov	DWORD PTR $T149233[esp+416], edx
	fstp	QWORD PTR $T127189[esp+420]
	mov	DWORD PTR $T149234[esp+416], edx
	lea	eax, DWORD PTR _dst$[esp+412]
	mov	DWORD PTR $T149233[esp+428], ecx
	lea	edx, DWORD PTR $T127189[esp+412]
	fst	QWORD PTR $T127189[esp+428]
	mov	DWORD PTR $T149234[esp+428], ecx
	fstp	QWORD PTR $T127189[esp+436]
	push	eax
	lea	ecx, DWORD PTR $T149235[esp+416]
	mov	DWORD PTR $T149233[esp+416], OFFSET ??_7_InputArray@cv@@6B@
	mov	DWORD PTR $T149234[esp+416], OFFSET ??_7_InputArray@cv@@6B@
	mov	DWORD PTR $T149234[esp+424], edx
	call	esi
	lea	ecx, DWORD PTR $T149232[esp+412]
	push	ecx
	lea	edx, DWORD PTR $T149233[esp+416]
	push	edx
	lea	eax, DWORD PTR $T149234[esp+420]
	push	eax
	lea	ecx, DWORD PTR $T149235[esp+424]
	push	ecx
	call	DWORD PTR __imp_?inRange@cv@@YAXABV_InputArray@1@00ABV_OutputArray@1@@Z

; 206  : 			//erode and dilate with larger element so make sure object is nicely visible
; 207  : 			Mat erodeElement = getStructuringElement( MORPH_RECT,Size(2,2));

	add	esp, 8
	mov	eax, esp
	mov	DWORD PTR $T149236[esp+420], esp
	sub	esp, 8
	mov	DWORD PTR [eax], -1
	mov	DWORD PTR [eax+4], -1
	mov	eax, esp
	mov	DWORD PTR $T149237[esp+428], esp
	lea	edx, DWORD PTR _erodeElement$[esp+428]
	push	ebx
	push	edx
	mov	DWORD PTR [eax], 2
	mov	DWORD PTR [eax+4], 2
...
; 208  : 			Mat dilateElement = getStructuringElement( MORPH_RECT,Size(4,4));

	add	esp, 16					; 00000010H
	mov	eax, esp
	mov	BYTE PTR __$EHRec$[esp+428], 2
	mov	DWORD PTR $T149238[esp+420], esp
	mov	DWORD PTR [eax], -1
	mov	DWORD PTR [eax+4], -1
	sub	esp, 8
	mov	eax, esp
	mov	DWORD PTR $T149239[esp+428], esp
	mov	DWORD PTR [eax], 4
	mov	DWORD PTR [eax+4], 4
	lea	eax, DWORD PTR _dilateElement$[esp+428]
	push	ebx
	push	eax
	call	DWORD PTR __imp_?getStructuringElement@cv@@YA?AVMat@1@HV?$Size_@H@1@V?$Point_@H@1@@Z
	add	esp, 24					; 00000018H

; 209  : 			erode(dst,dst,erodeElement);

	lea	ecx, DWORD PTR _erodeElement$[esp+412]
	push	ecx
	lea	ecx, DWORD PTR $T149242[esp+416]
	mov	BYTE PTR __$EHRec$[esp+424], 3
	call	esi
	lea	edx, DWORD PTR _dst$[esp+412]
	push	edx
	lea	ecx, DWORD PTR $T149243[esp+416]
	call	edi
	lea	eax, DWORD PTR _dst$[esp+412]
	push	eax
	lea	ecx, DWORD PTR $T149244[esp+416]
	call	esi
	fld	QWORD PTR __real@7fefffffffffffff
	lea	ecx, DWORD PTR $T149240[esp+412]
	fst	QWORD PTR $T149240[esp+412]
	push	ecx
	fst	QWORD PTR $T149240[esp+424]
	push	ebx
	fst	QWORD PTR $T149240[esp+436]
	push	1
	fstp	QWORD PTR $T149240[esp+448]
	sub	esp, 8
	mov	eax, esp
	mov	DWORD PTR $T149241[esp+432], esp
	lea	edx, DWORD PTR $T149242[esp+432]
	mov	DWORD PTR [eax], -1
	mov	DWORD PTR [eax+4], -1
	push	edx
	lea	eax, DWORD PTR $T149243[esp+436]
	push	eax
	lea	ecx, DWORD PTR $T149244[esp+440]
	push	ecx
	call	DWORD PTR __imp_?erode@cv@@YAXABV_InputArray@1@ABV_OutputArray@1@0V?$Point_@H@1@HHABV?$Scalar_@N@1@@Z
	add	esp, 32					; 00000020H

; 210  : 			erode(dst,dst,erodeElement);

	lea	edx, DWORD PTR _erodeElement$[esp+412]
	push	edx
	lea	ecx, DWORD PTR $T149247[esp+416]
	call	esi
	lea	eax, DWORD PTR _dst$[esp+412]
	push	eax
	lea	ecx, DWORD PTR $T149248[esp+416]
	call	edi
	lea	ecx, DWORD PTR _dst$[esp+412]
	push	ecx
	lea	ecx, DWORD PTR $T149249[esp+416]
	call	esi
	fld	QWORD PTR __real@7fefffffffffffff
	lea	edx, DWORD PTR $T149245[esp+412]
	fst	QWORD PTR $T149245[esp+412]
	push	edx
	fst	QWORD PTR $T149245[esp+424]
	push	ebx
	fst	QWORD PTR $T149245[esp+436]
	push	1
	fstp	QWORD PTR $T149245[esp+448]
	sub	esp, 8
	mov	eax, esp
	mov	DWORD PTR [eax], -1
	mov	DWORD PTR [eax+4], -1
	mov	DWORD PTR $T149246[esp+432], esp
	lea	eax, DWORD PTR $T149247[esp+432]
	push	eax
	lea	ecx, DWORD PTR $T149248[esp+436]
	push	ecx
	lea	edx, DWORD PTR $T149249[esp+440]
	push	edx
	call	DWORD PTR __imp_?erode@cv@@YAXABV_InputArray@1@ABV_OutputArray@1@0V?$Point_@H@1@HHABV?$Scalar_@N@1@@Z
	add	esp, 32					; 00000020H

; 211  : 			dilate(dst,dst,dilateElement);

	lea	eax, DWORD PTR _dilateElement$[esp+412]
	push	eax
	lea	ecx, DWORD PTR $T149252[esp+416]
	call	esi
	lea	ecx, DWORD PTR _dst$[esp+412]
	push	ecx
	lea	ecx, DWORD PTR $T149253[esp+416]
	call	edi
	lea	edx, DWORD PTR _dst$[esp+412]
	push	edx
	lea	ecx, DWORD PTR $T149254[esp+416]
	call	esi
	fld	QWORD PTR __real@7fefffffffffffff
	lea	eax, DWORD PTR $T149250[esp+412]
	fst	QWORD PTR $T149250[esp+412]
	push	eax
	fst	QWORD PTR $T149250[esp+424]
	push	ebx
	fst	QWORD PTR $T149250[esp+436]
	push	1
	fstp	QWORD PTR $T149250[esp+448]
	sub	esp, 8
	mov	eax, esp
	mov	DWORD PTR $T149251[esp+432], esp
	lea	ecx, DWORD PTR $T149252[esp+432]
	push	ecx
	lea	edx, DWORD PTR $T149253[esp+436]
	mov	DWORD PTR [eax], -1
	mov	DWORD PTR [eax+4], -1
	push	edx
	lea	eax, DWORD PTR $T149254[esp+440]
	push	eax
	call	DWORD PTR __imp_?dilate@cv@@YAXABV_InputArray@1@ABV_OutputArray@1@0V?$Point_@H@1@HHABV?$Scalar_@N@1@@Z
	add	esp, 32					; 00000020H

; 212  : 			dilate(dst,dst,dilateElement);

	lea	ecx, DWORD PTR _dilateElement$[esp+412]
	push	ecx
	lea	ecx, DWORD PTR $T149257[esp+416]
	call	esi
	lea	edx, DWORD PTR _dst$[esp+412]
	push	edx
	lea	ecx, DWORD PTR $T149258[esp+416]
	call	edi
	lea	eax, DWORD PTR _dst$[esp+412]
	push	eax
	lea	ecx, DWORD PTR $T149259[esp+416]
	call	esi
	fld	QWORD PTR __real@7fefffffffffffff
	lea	ecx, DWORD PTR $T149255[esp+412]
	fst	QWORD PTR $T149255[esp+412]
	push	ecx
	fst	QWORD PTR $T149255[esp+424]
	push	ebx
	fst	QWORD PTR $T149255[esp+436]
	push	1
	fstp	QWORD PTR $T149255[esp+448]
	sub	esp, 8
	mov	DWORD PTR $T149256[esp+432], esp
	mov	eax, esp
	lea	edx, DWORD PTR $T149257[esp+432]
	mov	DWORD PTR [eax], -1
	mov	DWORD PTR [eax+4], -1
	push	edx
	lea	eax, DWORD PTR $T149258[esp+436]
	push	eax
	lea	ecx, DWORD PTR $T149259[esp+440]
	push	ecx
	call	DWORD PTR __imp_?dilate@cv@@YAXABV_InputArray@1@ABV_OutputArray@1@0V?$Point_@H@1@HHABV?$Scalar_@N@1@@Z

; 213  : 			axisValue = trackFilteredObject(dst);

	sub	esp, 24					; 00000018H
	lea	edi, DWORD PTR _dst$[esp+468]
	mov	esi, esp
	mov	DWORD PTR $T149260[esp+468], esp
	call	??0Mat@cv@@QAE@ABV01@@Z			; cv::Mat::Mat
	call	?trackFilteredObject@CVDetector@@YAHVMat@cv@@@Z ; CVDetector::trackFilteredObject

; 214  : 			printf("Axis value = %d\n",axisValue);

	push	eax
	push	OFFSET ??_C@_0BB@HGDFHEIC@Axis?5value?5?$DN?5?$CFd?6?$AA@
	mov	DWORD PTR _axisValue, eax
	call	DWORD PTR __imp__printf
	add	esp, 64					; 00000040H

; 215  : 			// Show the processed image
; 216  : 			//imshow("Example3-out", dst);
; 217  : 			//imshow("Example3-in", dst);
; 218  : 			//waitKey(30); //this must be here or image will not be displayed :/
; 219  : 			//... uncomment for debug mode
; 220  : 			
; 221  : 		}

	lea	eax, DWORD PTR _dilateElement$[esp+412]
	mov	BYTE PTR __$EHRec$[esp+420], 2
	call	??1Mat@cv@@QAE@XZ			; cv::Mat::~Mat
	lea	eax, DWORD PTR _erodeElement$[esp+412]
	mov	BYTE PTR __$EHRec$[esp+420], 1
	call	??1Mat@cv@@QAE@XZ			; cv::Mat::~Mat
	mov	eax, edi
	mov	BYTE PTR __$EHRec$[esp+420], bl
	call	??1Mat@cv@@QAE@XZ			; cv::Mat::~Mat
	lea	eax, DWORD PTR _frame$[esp+412]
	mov	DWORD PTR __$EHRec$[esp+420], -1
	call	??1Mat@cv@@QAE@XZ			; cv::Mat::~Mat
	mov	ecx, DWORD PTR __$EHRec$[esp+412]
	mov	DWORD PTR fs:0, ecx
	pop	ecx
	pop	edi
	pop	esi
...
; 192  : 			Mat frame = hwnd2mat(hDesktopWnd);

	lea	esi, DWORD PTR _frame$[esp+100]
	call	?hwnd2mat@CVDetector@@YA?AVMat@cv@@PAUHWND__@@@Z ; CVDetector::hwnd2mat

; 193  : 			signID = detectAndDisplay(frame, *enable_cascade, *disable_cascade);

	sub	esp, 56					; 00000038H
	mov	edi, esi
	mov	DWORD PTR __$EHRec$[esp+164], 0
	mov	esi, esp
	mov	DWORD PTR $T149669[esp+156], esp
	call	??0Mat@cv@@QAE@ABV01@@Z			; cv::Mat::Mat
	sub	esp, 132				; 00000084H
	mov	BYTE PTR __$EHRec$[esp+296], 1
	mov	ecx, DWORD PTR _disable_cascade
	mov	eax, esp
	mov	DWORD PTR $T149667[esp+288], esp
	push	eax
	call	??0CascadeClassifier@cv@@QAE@ABV01@@Z
	sub	esp, 132				; 00000084H
	mov	ecx, esp
	mov	DWORD PTR $T149668[esp+420], esp
	mov	BYTE PTR __$EHRec$[esp+428], 2
	push	ecx
...
; 194  : 			waitKey(30); // -------------->uncomment this for debug mode
...
; 163  : 			HDC hDesktopDC;
; 164  : 			hDesktopWnd=GetDesktopWindow();

	call	DWORD PTR __imp__GetDesktopWindow@0

; 165  : 			hDesktopDC=GetDC(hDesktopWnd);

	push	eax
	mov	DWORD PTR _hDesktopWnd, eax
	call	DWORD PTR __imp__GetDC@4

; 166  : 			disable_cascade = new CascadeClassifier;
...
; 167  : 			enable_cascade = new CascadeClassifier;

	push	132					; 00000084H
	mov	DWORD PTR _disable_cascade, eax
	call	esi
	add	esp, 4
	mov	DWORD PTR $T149687[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 1
	test	eax, eax
...
; 170  : 			cascade_enable = "classifier_enable.xml";
...
; 171  : 			cascade_disable = "classifier_disable.xml";
...
; 172  : 			if( !(*enable_cascade).load( cascade_enable ) ){ return -1; };
...
; 173  : 			if( !(*disable_cascade).load( cascade_disable ) ){ return -1; };
...
; 174  : 
; 175  : 			// get the height and width of the screen
; 176  : 			int height = GetSystemMetrics(SM_CYVIRTUALSCREEN);

	mov	esi, DWORD PTR __imp__GetSystemMetrics@4
	push	79					; 0000004fH
	call	esi

; 177  : 			int width = GetSystemMetrics(SM_CXVIRTUALSCREEN);
...
; 178  : 
; 179  : 			// create a bitmap
; 180  : 			HBITMAP hbDesktop = CreateCompatibleBitmap( hDesktopDC, width, height);
...
; 181  : 
; 182  : 			/*while(1){ //----------->comment this for release mode
; 183  : 				//detectSigns();
; 184  : 				RoadTracker::doTracking();
; 185  : 			}*/
; 186  : 			
; 187  : 			return 0;
